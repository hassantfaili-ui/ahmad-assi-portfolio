...
buildingType: Four storey coach house, documentation and design report
...
imageGroups:
  ...
  - layout: full
    caption: Where it started. Hand drawn plans and a section sketch, then the same idea built in SketchUp.
    images:
      - src: /media/coach-house/coach-sketches.jpg
        alt: Hand drawn plan studies on sketchbook paper with a perspective sketch of the double height space, and the initial SketchUp model cut open beside them
  - layout: pair
    caption: The energy case, which is what the sustainability argument had to stand on.
    images:
      - src: /media/coach-house/coach-energy-use.jpg
        alt: Energy, carbon dioxide and cost charts from the Climate Plus Beta model with the annual energy use intensity noted beneath
      - src: /media/coach-house/coach-pv-generation.jpg
        alt: Photovoltaic generation calculated in the NREL PVWatts calculator, returning 4,873 kilowatt hours a year with the monthly breakdown
drawings:
  ...
  - src: /media/coach-house/coach-01.jpg
  ...
  - src: /media/coach-house/coach-06.jpg
    alt: Site plan with the contours drawn around the building footprint
